<?php
    ...
    class User{
        ...
        public function createUser(){
            try {
                $sql = 'INSERT INTO usuarios VALUES (:rol_code,:userCode,:userName,:userLastName,:userId,:userEmail,:userPass,:userState)';
                $stmt = $this->dbh->prepare($sql);
        ...
        # CU10 - Obtener el Usuario por el código
